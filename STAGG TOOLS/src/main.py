...
def main():
    ...
    # Set Console title
    set_console_title("STAGG V1 | Made by KBS | Menu")
    ...
    info = f"""{Fore.LIGHTCYAN_EX}\t\t\t\t\t  [+] Made by KBS [+]"""
    for x in info:
        time.sleep(0.0001)
        sys.stdout.write(x)
        sys.stdout.flush()
...
# ========================================================================================================================================================= #
    ...
    choice = input(f"#{Fore.LIGHTCYAN_EX}:{Fore.WHITE}>> ")
    if choice == "1":
        clear_banner()
        token = input(f"Token{Fore.LIGHTCYAN_EX}:{Fore.WHITE}>> ")
        message = "@here Nuked by KBS"
...
def socials():
    ...
    # Set Console title
    set_console_title("STAGG V1 | Made by KBS | Socials")
